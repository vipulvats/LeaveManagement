package com.lms.leaveservice.model;
...
public class LeaveTransaction {
	...
	public LeaveTransaction(String emp_id, Types leaveType, LocalDate startDate, LocalDate endDate, Status status, String reason) {
		this.emp_id = emp_id;
